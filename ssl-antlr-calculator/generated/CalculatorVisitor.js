...
export default class CalculatorVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by CalculatorParser#comandos.
	visitComandos(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by CalculatorParser#crear.
	visitCrear(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#push.
	visitPush(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#pop.
	visitPop(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#peek.
	visitPeek(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by CalculatorParser#nombre.
	visitNombre(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by CalculatorParser#texto.
	visitTexto(ctx) {
	  return this.visitChildren(ctx);
	}
